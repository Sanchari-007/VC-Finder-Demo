      ...
      <footer className="bg-white border-t mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600">
            ...
            <p className="text-sm">Disclaimer: This web application is built for demonstration purposes using synthetic data generated by AI. All names, contact details, and other information are entirely fictional. Any resemblance to real persons or entities is purely coincidental, and the developer is not responsible for any such similarities.</p>
            <br>
            </br>
